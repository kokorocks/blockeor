...
function make_activated_thumper () {
    for (let value4 of tiles.getTilesByType(assets.tile`myTile32`)) {
        ...
        tiles.setTileAt(value4, assets.tile`myTile1`)
    }
}
...
function Make_thumper () {
    for (let value5 of tiles.getTilesByType(assets.tile`myTile13`)) {
        smusher = sprites.create(img`
            ...
            . . d . d . d . . d . d . d . . 
            `, SpriteKind.Thumper)
        tiles.placeOnTile(smusher, value5)
...
game.onUpdate(function () {
    for (let value6 of sprites.allOfKind(SpriteKind.mushroom)) {
        if (value6.isHittingTile(CollisionDirection.Left)) {
            value6.setVelocity(50, 0)
            animation.runImageAnimation(
            value6,
            [img`
                . . . . b b b b . . . . . . . . 
        ...
        } else if (value6.isHittingTile(CollisionDirection.Right)) {
            value6.setVelocity(-50, 0)
            animation.runImageAnimation(
            value6,
            [img`
    ...
    for (let value7 of sprites.allOfKind(SpriteKind.activate)) {
        if (value7.x - mySprite.x < 10) {
            if (value7.y > mySprite.y) {
                value7.ay = -500
            } else {
                value7.ay = 500
            }
